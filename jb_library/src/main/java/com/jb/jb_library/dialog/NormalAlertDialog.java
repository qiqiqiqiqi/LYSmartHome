...
import com.jb.jb_library.intf.DialogOnClickListener;
...
public class NormalAlertDialog implements View.OnClickListener {
    ...
    public static class Builder {
        ...
        public Builder(Context context) {
            ...
            isSingleMode = false;
            singleButtonText = "确定";
            singleButtonTextColor = ContextCompat.getColor(mContext, R.color.color_363636);
            leftButtonText = "取消";
            leftButtonTextColor = ContextCompat.getColor(mContext, R.color.color_363636);
            rightButtonText = "确定";
            rightButtonTextColor = ContextCompat.getColor(mContext, R.color.color_363636);
