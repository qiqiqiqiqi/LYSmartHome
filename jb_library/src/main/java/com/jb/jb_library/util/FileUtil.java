...
public class FileUtil {
    ...
    private static String PHOTO_PICKER = "photo_picker";

    /**
     * 判断SD卡是否挂载
     */
    public static boolean isSDCardAvailable() {
        if (MEDIA_MOUNTED.equals(Environment
    ...
    public static String getPhotoPickerDir() {
        return getDir(PHOTO_PICKER);
    }
    ...
    public static File getFileStorage() {
        if (haveSdCard()) {
            ...
            File iconDir = new File(external, "file");
            if (!iconDir.exists()) {
                iconDir.mkdirs();
            }
            return iconDir;
