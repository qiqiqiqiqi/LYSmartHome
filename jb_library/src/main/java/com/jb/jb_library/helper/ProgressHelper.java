...
public class ProgressHelper {
    ...
    private int           mCircleRadius;
        ...
        mToSpin = true;
        mSpinSpeed = 0.75f;
        mBarWidth = ctx.getResources().getDimensionPixelSize(R.dimen.DIMEN_6PX) + 1;
        mBarColor = ctx.getResources().getColor(R.color.color_008F42);//修改颜色
        mRimWidth = 0;
        mRimColor = 0x00000000;
        mIsInstantProgress = false;
        mProgressVal = -1;
        mCircleRadius = ctx.getResources().getDimensionPixelOffset(R.dimen.DIMEN_68PX);
    }
