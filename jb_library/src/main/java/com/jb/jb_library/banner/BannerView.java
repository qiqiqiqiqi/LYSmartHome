package com.jb.jb_library.banner;
...
import com.jb.jb_library.banner.transformer.CoverModeTransformer;
import com.jb.jb_library.banner.transformer.ScaleYTransformer;
...
public class BannerView<T> extends RelativeLayout {
    ...
    private boolean mIsLoopAutoPlay;
    ...
    private void readAttrs(Context context, AttributeSet attrs) {
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.CustomBannerView);
        mIsOpenMZEffect = typedArray.getBoolean(R.styleable.CustomBannerView_open_mz_mode, true);
        mIsMiddlePageCover = typedArray.getBoolean(R.styleable.CustomBannerView_middle_page_cover, true);
        mIsLoopAutoPlay = typedArray.getBoolean(R.styleable.CustomBannerView_loopAutoPlay, true);
        mIsCanLoop = typedArray.getBoolean(R.styleable.CustomBannerView_canLoop, true);
        mIndicatorAlign = typedArray.getInt(R.styleable.CustomBannerView_indicatorAlign, IndicatorAlign.CENTER.ordinal());
        mIndicatorPaddingLeft = typedArray.getDimensionPixelSize(R.styleable.CustomBannerView_indicatorPaddingLeft, 0);
        mIndicatorPaddingRight = typedArray.getDimensionPixelSize(R.styleable.CustomBannerView_indicatorPaddingRight, 0);
        mIndicatorPaddingTop = typedArray.getDimensionPixelSize(R.styleable.CustomBannerView_indicatorPaddingTop, 0);
        mIndicatorPaddingBottom = typedArray.getDimensionPixelSize(R.styleable.CustomBannerView_indicatorPaddingBottom, 0);
        typedArray.recycle();
    }
    ...
    public class MZPagerAdapter<T> extends PagerAdapter {
        ...
        private View getView(int position, ViewGroup container) {
            ...
            if (mDatas != null && mDatas.size() > 0) {
                holder.onBind(container.getContext(), realPosition, mDatas.get(realPosition), view);
            }
