...
public class LightControlActivity extends JBBaseActivity  implements View.OnClickListener {
    public int[] BANNER = new int[]{R.mipmap.img_light, R.mipmap.img_light, R.mipmap.img_light, R.mipmap.img_light, R.mipmap.img_light};
    ...
    protected void init() {
        ...
        mBannerView.setPages(bannerList, new HolderCreator<LightControlActivity.BannerViewHolder>() {
            @Override
            public LightControlActivity.BannerViewHolder createViewHolder() {
                return new LightControlActivity.BannerViewHolder();
            }
        });
    ...
    protected void initTitle() {
        new TitleBarHelper(mActivity).setMiddleTitleText("LIGHT").setLeftImageRes(R.mipmap.back)
