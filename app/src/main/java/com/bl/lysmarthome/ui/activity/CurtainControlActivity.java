...
public class CurtainControlActivity extends JBBaseActivity  implements View.OnClickListener {
    public int[] BANNER = new int[]{R.mipmap.img_curtains, R.mipmap.img_curtains, R.mipmap.img_curtains, R.mipmap.img_curtains, R.mipmap.img_curtains};
    ...
    protected void init() {
        ...
        mBannerView.setPages(bannerList, new HolderCreator<CurtainControlActivity.BannerViewHolder>() {
            @Override
            public CurtainControlActivity.BannerViewHolder createViewHolder() {
                return new CurtainControlActivity.BannerViewHolder();
            }
        });
    ...
    protected void initTitle() {
        new TitleBarHelper(mActivity).setMiddleTitleText("CURTAIN").setLeftImageRes(R.mipmap.back)
